                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-black/40 text-gray-500 text-xs uppercase tracking-wider font-bold">
                            ...
                            <th className="p-4 border-b border-white/5">Joined</th>
                    ...
                    <tbody className="divide-y divide-white/5 text-sm">
                        {users.map(user => (
                            <tr key={user.email} className="hover:bg-white/5 transition-colors">
                                ...
                                <td className="p-4">
                                    <span className={`px-2 py-1 rounded text-xs font-bold uppercase tracking-wider border ${user.role === 'admin' ? 'bg-purple-500/10 text-purple-400 border-purple-500/20' : 'bg-gray-800 text-gray-400 border-gray-700'
                                        }`}>
                                        {user.role}
                                    </span>
                                </td>
                                ...
                                <td className="p-4 text-right">
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 ml-auto ${user.isBlocked
