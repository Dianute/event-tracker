  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-14 md:right-auto md:bottom-6 md:left-6 z-[1000] 
        ...
        overflow-y-auto
        gap-3 p-3
        max-h-[40vh] md:max-h-[60vh]
        hide-scrollbar pointer-events-none md:pointer-events-auto
        md:w-80
        bg-gradient-to-t from-black/90 via-black/50 to-transparent md:bg-none">
        {displayList.slice(0, 20).map(event => (
          <div key={event.id} className="pointer-events-auto w-full shrink-0 snap-start">
            <EventCard
              event={event}
