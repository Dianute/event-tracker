...
function VoidModal() {
    return (
        <div className="w-full max-w-sm bg-[#0a0a0a] rounded-xl p-8 text-center">
            <h3 className="text-3xl font-bold text-white mb-2 tracking-tight">Create your account</h3>
            <div className="text-sm text-gray-400 mb-8">
                Or <span className="text-blue-400 cursor-pointer hover:underline">sign in to your existing account</span>
            </div>

            <button className="w-full bg-[#131314] hover:bg-[#1b1b1c] border border-gray-600 rounded-full py-2.5 flex items-center justify-center gap-3 transition-colors group">
