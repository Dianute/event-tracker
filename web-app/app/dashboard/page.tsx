                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-gray-900/60 text-gray-500 text-[10px] uppercase tracking-[0.1em] font-black">
                                            <th className="p-5 w-16 border-b border-gray-700/50">#</th>
                                                    ...
                                                    <>
                                                        {isNewGroup && (
                                                            <tr key={`header-${currentDate}`} className="bg-gray-900/40 border-b border-gray-700/50">
                                                                <td colSpan={7} className="p-3 pl-4 text-xs font-bold text-cyan-500 uppercase tracking-widest sticky top-0 bg-gray-900/90 backdrop-blur-sm z-10">
